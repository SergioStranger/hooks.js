  ...
  <div class="mt-3 row justify-content-center">
    ...
    <div class="col-8">
      ...
      <div class="input-group flex-nowrap mb-3">
        ...
        <input type="password" class="form-control" placeholder="Discord вебхук" aria-describedby="addon-wrapping"
          v-model="DisTocken">
          <button class="btn btn-secondary" 
          type="submit" 
          v-clipboard:copy="this.DisTocken"
          v-clipboard:success="clipboardSuccessHandler"
          v-clipboard:error="clipboardErrorHandler">
          <i class="bi bi-clipboard-check"></i>
        </button>
      ...
      <router-link class="btn btn-success" to="/">Сохранить</router-link>
    </div>
  </div>
</template>
